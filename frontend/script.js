...
processBtn.addEventListener('click', async () => {
    ...
    const steps = [
        ...
        'Extracting text from PDF (this may take a bit)...',
    ...
    try {
        ...
        if (res.ok && data.analysis) {
            document.getElementById('summaryText').textContent = data.analysis.summary || 'Not available';
            document.getElementById('findingsText').textContent = data.analysis.key_findings || 'Not available';
            document.getElementById('methodText').textContent = data.analysis.methodology || 'Not available';
            document.getElementById('conclusionText').textContent = data.analysis.conclusion || 'Not available';
            ...
            analysisLoading.classList.add('hidden');
            analysisSections.classList.remove('hidden');
            document.getElementById('summaryText').textContent = errMsg;
            document.getElementById('findingsText').textContent = '—';
        ...
        analysisLoading.classList.add('hidden');
        analysisSections.classList.remove('hidden');
        document.getElementById('summaryText').textContent = 'Error: Could not connect to server.';
